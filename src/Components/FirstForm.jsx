            ...
            <div className='mt-4 my-2'>
                <form action="">
                    <div className=''>
                        ...
                        <div className='flex md:flex-row sm:flex-col  justify-between my-2 '>
                            <div className='pe-2 w-[50%]  py-2'>
                                <input type="text" placeholder='First Name' name='firstName' className='border border-[#BFBFBF] w-full  p-2 rounded outline-[#066AAB]' />
                            </div>
                            <div className='pe-2 w-[50%]  py-2'>
                    ...
                    <div className='my-2 py-2'>
                        ...
                        <div className=' pe-2'>
                            <input type="email"  placeholder='Email' name='email' className='border border-[#BFBFBF] w-full p-2 rounded outline-[#066AAB]' />
                        </div>
                    </div>
                    <div className='my-2 py-2'>
                        ...
                        <div className='flex md:flex-row justify-between my-2 '>
                            <div className='w-full'>
                                <input type="checkbox" value='Female' name='gender' className='border border-[#BFBFBF] rounded outline-[#066AAB] mx-2 text-[#066AAB]' />
                                <span>Female</span>
                            </div>
                            <div className='w-full'>
                                <input type="checkbox" value='Male' name='gender' className='border border-[#BFBFBF] p-4 rounded outline-[#066AAB] mx-2' />
                                <span>Male</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div>
                            <select className='border border-[#BFBFBF] w-full p-2 rounded outline-[#066AAB]' name='role'>
                                <option value=" "></option>
                    ...
                    <div className='my-2 py-2'>
                        ...
                        <div className=' pe-2'>
                            <input type="text" placeholder='Primary phone number' name='phoneNumber' className='border border-[#BFBFBF] w-full p-2 rounded outline-[#066AAB]' />
                        </div>
                    </div>
                    <div className='my-2 py-2'>
                        <legend className='font-bold my-2'>Secondary Phone Number</legend>
                        <div className=' pe-2'>
                            <input type="text" placeholder='Secondary phone number' className='border border-[#BFBFBF] w-full p-2 rounded outline-[#066AAB]'name='secondaryPhoneNumber' />
                        </div>
                    </div>
                    <div className='my-2 py-2'>
                        <legend className='font-bold my-2'>Means of Identification</legend>
                        <div>
                            <select className='border border-[#BFBFBF] w-full p-2 rounded outline-[#066AAB]' value={MeansOfIdentification} onChange={(e) => {setMeansOfIdentification(e.target.value)}}>
                                <option value=" "> </option>
                    ...
                    {MeansOfIdentification === "NIN" && (
                        <div className='my-2 py-2'>
                            ...
                            <div className=' pe-2'>
                                <input type="text" placeholder='Identification Number'  name='NINumber' className='border border-[#BFBFBF] w-full p-2 rounded outline-[#066AAB]' />
                            </div>
                        </div>
                    )}
                    ...
                    {MeansOfIdentification === "Driver's License" && (
                        <div className='my-2 py-2'>
                            ...
                            <div className=' pe-2'>
                                <input type="text" name='DriversIDNumber' placeholder="Drivers Number" className='border border-[#BFBFBF] w-full p-2 rounded outline-[#066AAB]' />
                            </div>
                        </div>
                    )}

                    {MeansOfIdentification === "Voter's Card" && (
                    <div className='my-2 py-2'>
                        ...
                        <div
                            ...
                            <input type="file" accept="image/*" name='votersCard' className="hidden" id="file-upload" />
                    ...
                    <div>
                        ...
                        <div className='flex md:flex-row sm:flex-col  justify-between my-2 '>
                            <div className='pe-2 w-[50%]  py-2'>
                                <input type="text" placeholder='Area' name='area' className='border border-[#BFBFBF] w-full  p-2 rounded outline-[#066AAB]' />
                            </div>
                            <div className='pe-2 w-[50%]  py-2'>
                                <input type="text" placeholder='State/Country' name='stateCountry' className='border border-[#BFBFBF] w-full  p-2 rounded outline-[#066AAB]' />
                            </div>
                        </div>
                    </div>
                    <div className='my-2 py-2 flex flex-row space-x-2 items-center'>
                        <button type='submit' onClick={() => onClick(index + 1)} className='hover:bg-[#055589] bg-[#066AAB] text-white py-2 px-6 my-2 rounded'>Next</button>
                        <div>
